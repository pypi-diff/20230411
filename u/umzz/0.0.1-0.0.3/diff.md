# Comparing `tmp/umzz-0.0.1.tar.gz` & `tmp/umzz-0.0.3.tar.gz`
...
+gzip compressed data, was "umzz-0.0.3.tar", last modified: Mon Apr 10 22:58:03 2023, max compression
```

## Comparing `umzz-0.0.1.tar` & `umzz-0.0.3.tar`
...
+drwxr-xr-x   0 a         (1000) a         (1000)        0 2023-04-10 22:58:03.833937 umzz-0.0.3/
+-rw-r--r--   0 a         (1000) a         (1000)    35149 2023-04-09 22:02:13.000000 umzz-0.0.3/LICENSE
+-rw-r--r--   0 a         (1000) a         (1000)     6908 2023-04-10 22:58:03.833937 umzz-0.0.3/PKG-INFO
+-rw-r--r--   0 a         (1000) a         (1000)     6346 2023-04-10 22:53:14.000000 umzz-0.0.3/README.md
+drwxr-xr-x   0 a         (1000) a         (1000)        0 2023-04-10 22:58:03.829937 umzz-0.0.3/bin/
+-rw-r--r--   0 a         (1000) a         (1000)       57 2023-04-09 22:02:13.000000 umzz-0.0.3/bin/umzz
+-rw-r--r--   0 a         (1000) a         (1000)       38 2023-04-10 22:58:03.833937 umzz-0.0.3/setup.cfg
+-rw-r--r--   0 a         (1000) a         (1000)     1147 2023-04-10 22:57:51.000000 umzz-0.0.3/setup.py
+drwxr-xr-x   0 a         (1000) a         (1000)        0 2023-04-10 22:58:03.833937 umzz-0.0.3/umzz/
+-rw-r--r--   0 a         (1000) a         (1000)        1 2023-04-09 22:02:13.000000 umzz-0.0.3/umzz/__init__.py
+-rw-r--r--   0 a         (1000) a         (1000)     2331 2023-04-09 22:02:13.000000 umzz-0.0.3/umzz/argue.py
+-rw-r--r--   0 a         (1000) a         (1000)      779 2023-04-10 22:53:14.000000 umzz-0.0.3/umzz/chunky.py
+-rw-r--r--   0 a         (1000) a         (1000)      801 2023-04-10 22:53:14.000000 umzz-0.0.3/umzz/cli.py
+-rw-r--r--   0 a         (1000) a         (1000)     1190 2023-04-10 22:53:14.000000 umzz-0.0.3/umzz/sliding.py
+-rw-r--r--   0 a         (1000) a         (1000)     1262 2023-04-09 22:02:13.000000 umzz-0.0.3/umzz/timer.py
+-rw-r--r--   0 a         (1000) a         (1000)     4286 2023-04-10 22:53:14.000000 umzz-0.0.3/umzz/umzz.py
+-rw-r--r--   0 a         (1000) a         (1000)       37 2023-04-10 22:53:14.000000 umzz-0.0.3/umzz/version.py
+-rw-r--r--   0 a         (1000) a         (1000)    11630 2023-04-10 22:53:14.000000 umzz-0.0.3/umzz/x9mp.py
+drwxr-xr-x   0 a         (1000) a         (1000)        0 2023-04-10 22:58:03.833937 umzz-0.0.3/umzz.egg-info/
+-rw-r--r--   0 a         (1000) a         (1000)     6908 2023-04-10 22:58:03.000000 umzz-0.0.3/umzz.egg-info/PKG-INFO
+-rw-r--r--   0 a         (1000) a         (1000)      304 2023-04-10 22:58:03.000000 umzz-0.0.3/umzz.egg-info/SOURCES.txt
+-rw-r--r--   0 a         (1000) a         (1000)        1 2023-04-10 22:58:03.000000 umzz-0.0.3/umzz.egg-info/dependency_links.txt
+-rw-r--r--   0 a         (1000) a         (1000)       78 2023-04-10 22:58:03.000000 umzz-0.0.3/umzz.egg-info/requires.txt
+-rw-r--r--   0 a         (1000) a         (1000)        5 2023-04-10 22:58:03.000000 umzz-0.0.3/umzz.egg-info/top_level.txt
```

### Comparing `umzz-0.0.1/LICENSE` & `umzz-0.0.3/LICENSE`

 * *Files identical despite different names*

### Comparing `umzz-0.0.1/setup.py` & `umzz-0.0.3/setup.py`
...
### Comparing `umzz-0.0.1/umzz/argue.py` & `umzz-0.0.3/umzz/argue.py`

 * *Files identical despite different names*

### Comparing `umzz-0.0.1/umzz/chunky.py` & `umzz-0.0.3/umzz/chunky.py`
...
### Comparing `umzz-0.0.1/umzz/cli.py` & `umzz-0.0.3/umzz/cli.py`
...
### Comparing `umzz-0.0.1/umzz/sliding.py` & `umzz-0.0.3/umzz/sliding.py`
...
### Comparing `umzz-0.0.1/umzz/timer.py` & `umzz-0.0.3/umzz/timer.py`
...
### Comparing `umzz-0.0.1/umzz/x9mp.py` & `umzz-0.0.3/umzz/x9mp.py`
