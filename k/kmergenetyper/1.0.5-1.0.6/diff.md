# Comparing `tmp/kmergenetyper-1.0.5.tar.gz` & `tmp/kmergenetyper-1.0.6.tar.gz`
...
## Comparing `kmergenetyper-1.0.5.tar` & `kmergenetyper-1.0.6.tar`
...
### Comparing `kmergenetyper-1.0.5/LICENSE` & `kmergenetyper-1.0.6/LICENSE`

 * *Files identical despite different names*

### Comparing `kmergenetyper-1.0.5/bin/kmergenetyper` & `kmergenetyper-1.0.6/bin/kmergenetyper`

 * *Files identical despite different names*

### Comparing `kmergenetyper-1.0.5/kmergenetyper/kma.py` & `kmergenetyper-1.0.6/kmergenetyper/kma.py`

 * *Files identical despite different names*

### Comparing `kmergenetyper-1.0.5/kmergenetyper/realignConsensus.py` & `kmergenetyper-1.0.6/kmergenetyper/realignConsensus.py`
...
### Comparing `kmergenetyper-1.0.5/kmergenetyper/typeGenes.py` & `kmergenetyper-1.0.6/kmergenetyper/typeGenes.py`
