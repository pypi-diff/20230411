# Comparing `tmp/notionshell-0.2.tar.gz` & `tmp/notionshell-0.3.tar.gz`
...
## Comparing `notionshell-0.2.tar` & `notionshell-0.3.tar`
...
### Comparing `notionshell-0.2/PKG-INFO` & `notionshell-0.3/PKG-INFO`
...
### Comparing `notionshell-0.2/notionshell.egg-info/PKG-INFO` & `notionshell-0.3/notionshell.egg-info/PKG-INFO`
