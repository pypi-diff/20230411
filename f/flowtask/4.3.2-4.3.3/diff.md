# Comparing `tmp/flowtask-4.3.2.tar.gz` & `tmp/flowtask-4.3.3.tar.gz`
...
### Comparing `flowtask-4.3.2/flowtask/components/CreateReport/charts/bar.py` & `flowtask-4.3.3/flowtask/components/CreateReport/charts/bar.py`
...
### Comparing `flowtask-4.3.2/flowtask/components/QSBase.py` & `flowtask-4.3.3/flowtask/components/QSBase.py`
...
### Comparing `flowtask-4.3.2/flowtask/components/Sharepoint.py` & `flowtask-4.3.3/flowtask/components/Sharepoint.py`
...
### Comparing `flowtask-4.3.2/flowtask/components/UPCDatabase.py` & `flowtask-4.3.3/flowtask/components/UPCDatabase.py`
...
### Comparing `flowtask-4.3.2/flowtask/components/UploadToS3.py` & `flowtask-4.3.3/flowtask/components/UploadToS3.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/components/UploadToSFTP.py` & `flowtask-4.3.3/flowtask/components/UploadToSFTP.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/components/UserFunc.py` & `flowtask-4.3.3/flowtask/components/UserFunc.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/components/WSDLClient.py` & `flowtask-4.3.3/flowtask/components/WSDLClient.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/components/XMLtoPandas.py` & `flowtask-4.3.3/flowtask/components/XMLtoPandas.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/components/__init__.py` & `flowtask-4.3.3/flowtask/components/__init__.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/components/abstract.py` & `flowtask-4.3.3/flowtask/components/abstract.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/components/azureauth.py` & `flowtask-4.3.3/flowtask/components/azureauth.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/components/functions.py` & `flowtask-4.3.3/flowtask/components/functions.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/components/group.py` & `flowtask-4.3.3/flowtask/components/group.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/components/interfaces.py` & `flowtask-4.3.3/flowtask/components/interfaces.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/components/tConcat.py` & `flowtask-4.3.3/flowtask/components/tConcat.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/components/tFilter.py` & `flowtask-4.3.3/flowtask/components/tFilter.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/components/tJoin.py` & `flowtask-4.3.3/flowtask/components/tJoin.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/components/tMap.py` & `flowtask-4.3.3/flowtask/components/tMap.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/components/tPluckCols.py` & `flowtask-4.3.3/flowtask/components/tPluckCols.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/components/user.py` & `flowtask-4.3.3/flowtask/components/user.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/conf.py` & `flowtask-4.3.3/flowtask/conf.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/download.py` & `flowtask-4.3.3/flowtask/download.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/events.py` & `flowtask-4.3.3/flowtask/events.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/exceptions.c` & `flowtask-4.3.3/flowtask/exceptions.c`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/models.py` & `flowtask-4.3.3/flowtask/models.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/parsers/_yaml.c` & `flowtask-4.3.3/flowtask/parsers/_yaml.c`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/parsers/argparser.py` & `flowtask-4.3.3/flowtask/parsers/argparser.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/parsers/base.c` & `flowtask-4.3.3/flowtask/parsers/base.c`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/parsers/json.c` & `flowtask-4.3.3/flowtask/parsers/json.c`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/parsers/maps.py` & `flowtask-4.3.3/flowtask/parsers/maps.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/parsers/toml.c` & `flowtask-4.3.3/flowtask/parsers/toml.c`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/plugins/handler/__init__.py` & `flowtask-4.3.3/flowtask/plugins/handler/__init__.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/plugins/importer.py` & `flowtask-4.3.3/flowtask/plugins/importer.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/runner.py` & `flowtask-4.3.3/flowtask/runner.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/scheduler/handlers/manager.py` & `flowtask-4.3.3/flowtask/scheduler/handlers/manager.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/scheduler/handlers/service.py` & `flowtask-4.3.3/flowtask/scheduler/handlers/service.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/scheduler/scheduler.py` & `flowtask-4.3.3/flowtask/scheduler/scheduler.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/tasks/abstract.py` & `flowtask-4.3.3/flowtask/tasks/abstract.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/tasks/command.py` & `flowtask-4.3.3/flowtask/tasks/command.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/tasks/pile.py` & `flowtask-4.3.3/flowtask/tasks/pile.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/tasks/run.py` & `flowtask-4.3.3/flowtask/tasks/run.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/tasks/storages/abstract.py` & `flowtask-4.3.3/flowtask/tasks/storages/abstract.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/tasks/storages/database.py` & `flowtask-4.3.3/flowtask/tasks/storages/database.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/tasks/storages/filesystem.py` & `flowtask-4.3.3/flowtask/tasks/storages/filesystem.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/tasks/storages/row.py` & `flowtask-4.3.3/flowtask/tasks/storages/row.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/tasks/task.py` & `flowtask-4.3.3/flowtask/tasks/task.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/template/__init__.py` & `flowtask-4.3.3/flowtask/template/__init__.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/tests.py` & `flowtask-4.3.3/flowtask/tests.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/types/typedefs.c` & `flowtask-4.3.3/flowtask/types/typedefs.c`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/utils/__init__.py` & `flowtask-4.3.3/flowtask/utils/__init__.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/utils/_functions.py` & `flowtask-4.3.3/flowtask/utils/_functions.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/utils/constants.py` & `flowtask-4.3.3/flowtask/utils/constants.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/utils/executor.py` & `flowtask-4.3.3/flowtask/utils/executor.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/utils/functions.cpp` & `flowtask-4.3.3/flowtask/utils/functions.cpp`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/utils/json.cpp` & `flowtask-4.3.3/flowtask/utils/json.cpp`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/utils/mail.py` & `flowtask-4.3.3/flowtask/utils/mail.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/utils/parseqs.c` & `flowtask-4.3.3/flowtask/utils/parseqs.c`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/utils/stats.py` & `flowtask-4.3.3/flowtask/utils/stats.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask/utils/validators.py` & `flowtask-4.3.3/flowtask/utils/validators.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/flowtask.egg-info/PKG-INFO` & `flowtask-4.3.3/flowtask.egg-info/PKG-INFO`
...
### Comparing `flowtask-4.3.2/flowtask.egg-info/SOURCES.txt` & `flowtask-4.3.3/flowtask.egg-info/SOURCES.txt`
...
### Comparing `flowtask-4.3.2/flowtask.egg-info/requires.txt` & `flowtask-4.3.3/flowtask.egg-info/requires.txt`
...
### Comparing `flowtask-4.3.2/plugins/components/TestComponent.py` & `flowtask-4.3.3/plugins/components/TestComponent.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/plugins/sources/get_populartimes.py` & `flowtask-4.3.3/plugins/sources/get_populartimes.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/plugins/sources/google.py` & `flowtask-4.3.3/plugins/sources/google.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/plugins/sources/hubspot.py` & `flowtask-4.3.3/plugins/sources/hubspot.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/plugins/sources/icims.py` & `flowtask-4.3.3/plugins/sources/icims.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/plugins/sources/mobileinsight.py` & `flowtask-4.3.3/plugins/sources/mobileinsight.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/plugins/sources/newrelic.py` & `flowtask-4.3.3/plugins/sources/newrelic.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/plugins/sources/uap.py` & `flowtask-4.3.3/plugins/sources/uap.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/plugins/sources/venu.py` & `flowtask-4.3.3/plugins/sources/venu.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/plugins/sources/vocinity.py` & `flowtask-4.3.3/plugins/sources/vocinity.py`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/pyproject.toml` & `flowtask-4.3.3/pyproject.toml`

 * *Files identical despite different names*

### Comparing `flowtask-4.3.2/setup.py` & `flowtask-4.3.3/setup.py`
