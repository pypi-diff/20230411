# Comparing `tmp/clipcrop-1.0.5.tar.gz` & `tmp/clipcrop-1.0.6.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "clipcrop-1.0.5.tar", last modified: Tue Apr 11 16:46:28 2023, max compression
+gzip compressed data, was "clipcrop-1.0.6.tar", last modified: Tue Apr 11 16:50:31 2023, max compression
```

## Comparing `clipcrop-1.0.5.tar` & `clipcrop-1.0.6.tar`

### file list

```diff
@@ -1,16 +1,16 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-11 16:46:28.830482 clipcrop-1.0.5/
--rw-r--r--   0 runner    (1001) docker     (123)     1074 2023-04-11 16:46:20.000000 clipcrop-1.0.5/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)     3683 2023-04-11 16:46:28.830482 clipcrop-1.0.5/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     2894 2023-04-11 16:46:20.000000 clipcrop-1.0.5/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-11 16:46:28.826482 clipcrop-1.0.5/clipcrop/
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-04-11 16:46:20.000000 clipcrop-1.0.5/clipcrop/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     5193 2023-04-11 16:46:20.000000 clipcrop-1.0.5/clipcrop/clipcrop.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-11 16:46:28.826482 clipcrop-1.0.5/clipcrop.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     3683 2023-04-11 16:46:28.000000 clipcrop-1.0.5/clipcrop.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      268 2023-04-11 16:46:28.000000 clipcrop-1.0.5/clipcrop.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-04-11 16:46:28.000000 clipcrop-1.0.5/clipcrop.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-04-11 16:46:28.000000 clipcrop-1.0.5/clipcrop.egg-info/not-zip-safe
--rw-r--r--   0 runner    (1001) docker     (123)       51 2023-04-11 16:46:28.000000 clipcrop-1.0.5/clipcrop.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)        9 2023-04-11 16:46:28.000000 clipcrop-1.0.5/clipcrop.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       79 2023-04-11 16:46:28.830482 clipcrop-1.0.5/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     3417 2023-04-11 16:46:20.000000 clipcrop-1.0.5/setup.py
...
### Comparing `clipcrop-1.0.5/LICENSE` & `clipcrop-1.0.6/LICENSE`

 * *Files identical despite different names*

### Comparing `clipcrop-1.0.5/PKG-INFO` & `clipcrop-1.0.6/PKG-INFO`
...
### Comparing `clipcrop-1.0.5/README.md` & `clipcrop-1.0.6/README.md`

 * *Files identical despite different names*

### Comparing `clipcrop-1.0.5/clipcrop/clipcrop.py` & `clipcrop-1.0.6/clipcrop/clipcrop.py`
...
### Comparing `clipcrop-1.0.5/clipcrop.egg-info/PKG-INFO` & `clipcrop-1.0.6/clipcrop.egg-info/PKG-INFO`
...
### Comparing `clipcrop-1.0.5/setup.py` & `clipcrop-1.0.6/setup.py`
