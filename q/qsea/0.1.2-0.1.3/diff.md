# Comparing `tmp/qsea-0.1.2.tar.gz` & `tmp/qsea-0.1.3.tar.gz`
...
## Comparing `qsea-0.1.2.tar` & `qsea-0.1.3.tar`
...
### Comparing `qsea-0.1.2/LICENSE.txt` & `qsea-0.1.3/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `qsea-0.1.2/PKG-INFO` & `qsea-0.1.3/PKG-INFO`
...
### Comparing `qsea-0.1.2/qsea.egg-info/PKG-INFO` & `qsea-0.1.3/qsea.egg-info/PKG-INFO`
...
### Comparing `qsea-0.1.2/setup.py` & `qsea-0.1.3/setup.py`
