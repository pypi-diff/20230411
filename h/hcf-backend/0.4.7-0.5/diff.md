# Comparing `tmp/hcf-backend-0.4.7.tar.gz` & `tmp/hcf-backend-0.5.tar.gz`
...
+gzip compressed data, was "hcf-backend-0.5.tar", last modified: Tue Apr 11 21:05:03 2023, max compression
```

## Comparing `hcf-backend-0.4.7.tar` & `hcf-backend-0.5.tar`
...
+drwxrwxr-x   0 molveyra  (1001) molveyra  (1001)        0 2023-04-11 21:05:03.175032 hcf-backend-0.5/
+-rw-r--r--   0 molveyra  (1001) molveyra  (1001)     1478 2019-01-31 18:02:16.000000 hcf-backend-0.5/LICENSE
+-rw-rw-r--   0 molveyra  (1001) molveyra  (1001)     2684 2023-04-11 21:05:03.175032 hcf-backend-0.5/PKG-INFO
+-rw-rw-r--   0 molveyra  (1001) molveyra  (1001)     2067 2023-04-11 20:57:08.000000 hcf-backend-0.5/README.md
+drwxrwxr-x   0 molveyra  (1001) molveyra  (1001)        0 2023-04-11 21:05:03.175032 hcf-backend-0.5/hcf_backend/
+-rw-rw-r--   0 molveyra  (1001) molveyra  (1001)       44 2023-04-11 21:02:45.000000 hcf-backend-0.5/hcf_backend/__init__.py
+-rw-rw-r--   0 molveyra  (1001) molveyra  (1001)    14039 2023-04-11 20:57:08.000000 hcf-backend-0.5/hcf_backend/backend.py
+-rw-rw-r--   0 molveyra  (1001) molveyra  (1001)     4286 2021-07-13 20:41:18.000000 hcf-backend-0.5/hcf_backend/manager.py
+drwxrwxr-x   0 molveyra  (1001) molveyra  (1001)        0 2023-04-11 21:05:03.175032 hcf-backend-0.5/hcf_backend/utils/
+-rw-rw-r--   0 molveyra  (1001) molveyra  (1001)     1631 2023-04-11 20:57:08.000000 hcf-backend-0.5/hcf_backend/utils/__init__.py
+-rw-rw-r--   0 molveyra  (1001) molveyra  (1001)     3931 2023-04-11 20:57:08.000000 hcf-backend-0.5/hcf_backend/utils/crawlmanager.py
+-rw-rw-r--   0 molveyra  (1001) molveyra  (1001)    13289 2023-04-11 21:01:21.000000 hcf-backend-0.5/hcf_backend/utils/hcfpal.py
+drwxrwxr-x   0 molveyra  (1001) molveyra  (1001)        0 2023-04-11 21:05:03.175032 hcf-backend-0.5/hcf_backend.egg-info/
+-rw-rw-r--   0 molveyra  (1001) molveyra  (1001)     2684 2023-04-11 21:05:03.000000 hcf-backend-0.5/hcf_backend.egg-info/PKG-INFO
+-rw-rw-r--   0 molveyra  (1001) molveyra  (1001)      377 2023-04-11 21:05:03.000000 hcf-backend-0.5/hcf_backend.egg-info/SOURCES.txt
+-rw-rw-r--   0 molveyra  (1001) molveyra  (1001)        1 2023-04-11 21:05:03.000000 hcf-backend-0.5/hcf_backend.egg-info/dependency_links.txt
+-rw-rw-r--   0 molveyra  (1001) molveyra  (1001)      107 2023-04-11 21:05:03.000000 hcf-backend-0.5/hcf_backend.egg-info/requires.txt
+-rw-rw-r--   0 molveyra  (1001) molveyra  (1001)       12 2023-04-11 21:05:03.000000 hcf-backend-0.5/hcf_backend.egg-info/top_level.txt
+-rw-rw-r--   0 molveyra  (1001) molveyra  (1001)       31 2021-07-13 00:16:34.000000 hcf-backend-0.5/pyproject.toml
+-rw-rw-r--   0 molveyra  (1001) molveyra  (1001)       38 2023-04-11 21:05:03.175032 hcf-backend-0.5/setup.cfg
+-rw-rw-r--   0 molveyra  (1001) molveyra  (1001)     1010 2023-04-11 21:02:35.000000 hcf-backend-0.5/setup.py
```

### Comparing `hcf-backend-0.4.7/LICENSE` & `hcf-backend-0.5/LICENSE`

 * *Files identical despite different names*

### Comparing `hcf-backend-0.4.7/PKG-INFO` & `hcf-backend-0.5/PKG-INFO`
...
### Comparing `hcf-backend-0.4.7/README.md` & `hcf-backend-0.5/README.md`
...
### Comparing `hcf-backend-0.4.7/hcf_backend/backend.py` & `hcf-backend-0.5/hcf_backend/backend.py`

 * *Files identical despite different names*

### Comparing `hcf-backend-0.4.7/hcf_backend/manager.py` & `hcf-backend-0.5/hcf_backend/manager.py`

 * *Files identical despite different names*

### Comparing `hcf-backend-0.4.7/hcf_backend/utils/__init__.py` & `hcf-backend-0.5/hcf_backend/utils/__init__.py`

 * *Files identical despite different names*

### Comparing `hcf-backend-0.4.7/hcf_backend/utils/crawlmanager.py` & `hcf-backend-0.5/hcf_backend/utils/crawlmanager.py`

 * *Files identical despite different names*

### Comparing `hcf-backend-0.4.7/hcf_backend/utils/hcfpal.py` & `hcf-backend-0.5/hcf_backend/utils/hcfpal.py`
...
### Comparing `hcf-backend-0.4.7/hcf_backend.egg-info/PKG-INFO` & `hcf-backend-0.5/hcf_backend.egg-info/PKG-INFO`
...
### Comparing `hcf-backend-0.4.7/setup.py` & `hcf-backend-0.5/setup.py`
